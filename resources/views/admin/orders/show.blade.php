        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="mx-auto d-block">
                    ...
                    <h5 class="text-sm-center mt-2 mb-1">Shipping Cost: <span class="text-muted">{{$order->shipping_charge}}</span></h5>
                    <div class="location text-sm-center">Total : <span class="text-muted">{{$order->total_price}}</span></i></div>
                </div>
                <hr>
            </div>
        </div>
